...
function edToolbar(obj, url, png)
{
    ...
    document.write("<div class=\"btn-toolbar\" role=\"toolbar\">\n" +
                   ...
                   "    <img class=\"button\" src=\"" + url + "/removeformat." + end + "\" name=\"btnBold\" onClick=\"doRemoveTags('" + obj + "')\" \/>\n" +
                   "    <img src=\"" + url + "/separator.gif\" \/>\n" +
                   "  </div>\n" +

                   "  <div style=\"float: left;\">\n" +
                   "    <div style=\"padding:2px; float:left;\">Fonts</div>\n" +
                   "    <div style=\"float:left;\"><img class=\"button\" src=\"" + url + "/menupop." + end + "\" id=\"popFont\" onClick=\"showpopup('font','popFont')\" \/></div>\n" +
                   "    <div style=\"padding:2px; float:left;\">Size</div>\n" +
                   "    <div style=\"float:left;\"><img class=\"button\" src=\"" + url + "/menupop." + end + "\" id=\"popSize\" onClick=\"showpopup('size','popSize')\" \/></div>\n" +
                   "    <img src=\"" + url + "/separator.gif\" \/>\n" +
                   "  </div>\n" +

                   "  <div style=\"float: left;\">\n" +
                   "    <img class=\"button\" src=\"" + url + "/bold." + end + "\" name=\"btnBold\" onClick=\"doAddTags('[b]','[/b]','" + obj + "')\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/italic." + end + "\" name=\"btnItalic\" onClick=\"doAddTags('[i]','[/i]','" + obj + "')\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/underline." + end + "\" name=\"btnUnderline\" onClick=\"doAddTags('[u]','[/u]','" + obj + "')\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/pre." + end + "\" name=\"btnPre\" onClick=\"doAddTags('[pre]','[/pre]','" + obj + "')\" \/>\n" +
                   "    <img src=\"" + url + "/separator.gif\" \/>\n" +
                   "  </div>\n" +

                   "  <div style=\"float: left;\">\n" +
                   "    <img class=\"button\" src=\"" + url + "/center." + end + "\" name=\"btnLink\" onClick=\"doAddTags('[center]','[/center]','" + obj + "')\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/link." + end + "\" name=\"btnLink\" onClick=\"doURL('" + obj + "')\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/unlink." + end + "\" name=\"btnunLink\" onClick=\"doRemoveURL('" + obj + "')\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/image." + end + "\" name=\"btnPicture\" onClick=\"doImage('" + obj + "')\" />\n" +
                   "    <img src=\"" + url + "/separator.gif\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/orderedlist." + end + "\" name=\"btnList\" onClick=\"doList('[list=1]','[/list]','" + obj + "')\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/unorderedlist." + end + "\" name=\"btnList\" onClick=\"doList('[list]','[/list]','" + obj + "')\" \/>\n" +
                   "    <img src=\"" + url + "/separator.gif\" \/>\n" +
                   "    <img class=\"button\" src=\"" + url + "/quote." + end + "\" name=\"btnQuote\" onClick=\"doAddTags('[quote]','[/quote]','" + obj + "')\" \/>\n" +
                   "  </div>\n" +
                   "</div>\n" +
                   "<br style=\"clear: left;\" />\n");

    document.write("<div id=\"font\" class=\"dropdown-menu\" style=\"display: none;\">\n");
    ...
    document.write("<div id=\"size\" class=\"dropdown-menu\" style=\"display: none;\">\n");
    ...
    document.write("<div id=\"color\" class=\"dropdown-menu\" style=\"display: none;\">\n");
